...
<nav class="w3-sidebar w3-card-4 w3-bar-block w3-small w3-hide-small  " style="margin-top: 90px">
  ...
  <a href="index.php" class="w3-bar-item w3-button w3-padding-large w3-hover-grey" style="background-color: #f5deb3">
    <i>
    	<img src="./images/nav_home-icon2.png" width="22x" height="23px">
    </i><b style="margin-left: 3px; color:#000000">
  Home</b>
  </a>
...
<div id="main">
  ...
  <div class="w3-content w3-justify w3-text-black w3-padding-32" id="about">
    <!-- EDIT DISINI NIN -->
    <h2 class="w3-text-black" align="center">Selamat Datang</h2>
    <p align="center">Selamat datang di website Data Mahasiswa!
    </p>
    <hr>
	<div style= "display: inline-block; vertical-align: top">
	<img src="./images/FITK.jpg" width= "980px" height= "350px">
	</div>
	<div style="display: inline-block">
	<br>
	Sistem Informasi Mahasiswa ini adalah sebuah aplikasi berbasis web yang berisi tentang data mahasiswa/i pendidikan matematika. Web ini dibuat dengan tujuan untuk mengelola data mahasiswa pendidikan matematika dan untuk memenuhi tugas membuat aplikasi berbasis web pada mata kuliah Pemrograman Komputer yang diampu oleh Drs. Dindin Sobiruddin, M.Kom
	</div>
    <p></p>
</div>
<!-- END PAGE CONTENT -->
...
<hr>
<footer style="text-align: center"w>
